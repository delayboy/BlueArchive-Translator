...
public abstract record CliCommand(bool Profile);
...
public static class ExportOptions
{
    ...
    public static ExportCommand ParseExport(string[] args)
    {
        var metadataPath = @"global-metadata.dat"; 
        var outputPath = @"dump.cs";
