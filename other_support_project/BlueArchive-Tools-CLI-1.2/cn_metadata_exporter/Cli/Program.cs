...
public static class ExportCore
{
    ...
    public static int RunExport(ExportCommand command, ExportProfiler profiler)
    {
    ...
    private static byte[] ReadAndRestoreMetadata(string metadataPath, string? restoredOutputPath, uint keyConstant, ExportProfiler profiler, ExportProgress progress, out bool usedProtectedRestore)
    {
        ...
        {
            var directory = Path.GetDirectoryName(restoredOutputPath);
